...
fun RowScope.NewsNavigationBarItem(
    ...
    NavigationBarItem(
        ...
        colors = NavigationBarItemDefaults.colors(
            selectedIconColor = NewsNavigationDefaults.navigationSelectedItemColor(),
            unselectedIconColor = NewsNavigationDefaults.navigationContentColor(),
            selectedTextColor = NewsNavigationDefaults.navigationSelectedItemColor(),
            unselectedTextColor = NewsNavigationDefaults.navigationContentColor(),
            indicatorColor = NewsNavigationDefaults.navigationIndicatorColor()
        )
    )
}
...
fun NewsNavigationBar(
    ...
    NavigationBar(
        ...
        contentColor = NewsNavigationDefaults.navigationContentColor(),
        tonalElevation = 0.dp,
        content = content
    )
}
